...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}p{.2cm} L{6cm} L{\textwidth - 10cm} @{\extracolsep{\fill}}R{3cm}}
    ...
    \faIcon{book-open} & Story understanding &  \cite{Li2022} & \entrylocationstyle{2021 -- Present}\\
    \faIcon{d-and-d} & D\&D as an AI challenge & \cite{martin2018dungeons,CallisonBurch2022,Papazov2022, CallisonBurchEMNLP} & \entrylocationstyle{2018 -- Present}\\
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} p{.2cm} L{9cm} L{5.6cm} R{2.2cm}}
    ...
    \faIcon{reddit-alien} & Online communities  &\cite{moon2014identifying,GiorgiSubmitted} & \entrylocationstyle{2014, 2022}\\
