...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}p{.2cm} L{6cm} L{\textwidth - 10cm} @{\extracolsep{\fill}}R{3cm}}
    ...
    \faIcon{book-open} & Story understanding &  \cite{Li2022,Dong2022,Giorgi2023,DongSubmitted} & \entrylocationstyle{2021 -- Present}\\
    \faIcon{d-and-d} & D\&D as an AI challenge & \cite{martin2018dungeons,CallisonBurch2022,Papazov2022, CallisonBurchEMNLP,ZhuSubmitted} & \entrylocationstyle{2018 -- Present}\\
