...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}p{.2cm} L{6cm} L{\textwidth - 10cm} @{\extracolsep{\fill}}R{3cm}}
    ...
    \faIcon{d-and-d} & D\&D-Playing and Strategic Agents & \cite{Zhu2023AIIDE,martin2018dungeons,CallisonBurch2022,Papazov2022, CallisonBurchEMNLP,Zhu2023,Delafuente2025Reasoning,Sivakumar2025Simulating} & \entrylocationstyle{2018 -- Present}\\
    \faIcon{edit} & Story generation &  \cite{martin2016improvisational,martin2017improvisational,martin2017event,martin2018event,ammanabrolu2019guided,tambwekar2019controllable,ammanabrolu2020story,martin2021thesis,Alabdulkarim2021,Chambers2024BERALL,Huang2025WHAT-IF} & \entrylocationstyle{2015 -- Present}\\
    \faIcon{bezier-curve} & Schemas & \cite{martin2016improvisational,martin2018event,Zhang2023} & \entrylocationstyle{2023}\\
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} p{.2cm} L{9cm} L{5.6cm} R{2.2cm}}
    \setlength{\extrarowheight}{5pt}
    \faIcon{tty} & Augmentative and Alternative Communication (AAC) & \cite{Martin2025,Choudhury2025GPTsDevastated} & \entrylocationstyle{2022 -- Present}\\
    \faIcon{frown-open} & Emotion recognition \& affective computing &  \cite{martin2014methodology,cosentino2014,Yu2014,Yu2015,Choudhury2025GPTsDevastated}& \entrylocationstyle{2013 -- Present}\\
