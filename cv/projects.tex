...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}p{.2cm} L{6cm} L{\textwidth - 10cm} @{\extracolsep{\fill}}R{3cm}}
    ...
    \faIcon{book-open} & Story generation &  \cite{martin2016improvisational,martin2017improvisational,martin2017event,martin2018event,ammanabrolu2019guided,tambwekar2019controllable,ammanabrolu2020story,martin2021thesis,Alabdulkarim2021,Li2022} & \entrylocationstyle{2015-Present}\\
    \faIcon{d-and-d} & D\&D as an AI challenge & \cite{martin2018dungeons,CallisonBurch2022,Papazov2022, CallisonBurchSubmitted} & \entrylocationstyle{2018-Present}\\
    \faIcon{mobile} & Conversational agents & \cite{panagopoulouquakerbot}, See also: Amazon internship & \entrylocationstyle{2011, 2017, 2022}
\end{tabular*}
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} p{.2cm} L{9cm} L{5.8cm} R{2cm}}
    \setlength{\extrarowheight}{5pt}
    ...
    \faIcon{language} & Translation \& language learning & \cite{wolfeapplause,martin2015utterance}& \entrylocationstyle{2015}\\
    \faIcon{comments} & Online communities  &\cite{moon2014identifying,GiorgiSubmitted} & \entrylocationstyle{2014, 2022}\\
