...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}p{.2cm} L{6cm} L{\textwidth - 10cm} @{\extracolsep{\fill}}R{3cm}}
    ...
    \faIcon{d-and-d} & D\&D as an AI challenge & \cite{martin2018dungeons,CallisonBurch2022,Papazov2022, CallisonBurchEMNLP,Zhu2023, Zhu2023AIIDE} & \entrylocationstyle{2018 -- Present}\\
