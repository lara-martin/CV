...
\cvsection{\faIcon{search}}{Research Interests}

%\entrytitlestyle{Human-Centered AI}

%generally through neurosymbolic methods

\headerquotestyle{Human-Centered Artificial Intelligence, Natural Language Processing/Generation, Neurosymbolic Methods for NLP, Computational Creativity, Automated Story Generation \& Understanding, Tabletop Roleplaying Agents, Augmentative \& Alternative Communication (AAC) and Assistive Technologies (AT), Speech Processing, Affective Computing}
