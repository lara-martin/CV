...
%
% Adaptation by
% Lara J. Martin (laramar@umbc.edu)
%
% Template from 
...
\position{Assistant Professor, CSEE \bullet~University of Maryland, Baltimore County (UMBC)}
\address{Information Technology and Engineering (ITE) Building, Room 216}



\homepage{laramartin.net}
\email{laramar@umbc.edu}
\github{lara-martin}
...
%\mastodon{https://sigmoid.social/@laramar}
% \skype{skype-id}
% \reddit{reddit-id}
% \medium{madium-id}
\googlescholar{YjiWURYAAAAJ}{Google Scholar}
...
\AddToShipoutPictureBG*{%
  \AtPageUpperLeft{%
    \raisebox{-\height}{%
      \includegraphics[width=\paperwidth,height=0.19\paperwidth]{sidebar.png}% %0.175\paperwidth]{sidebar.png}%
    }%
  }
}
